...
namespace Pjr_Capa_Negocio
{
    public class CN_Perfil
    {
        ...
        {
            return cdPerfil.EditarPerfil(perfil.ClienteID1,perfil.Usuario1, perfil.Contraseña1, perfil.Nombre1, perfil.Apellido1, perfil.Correo, perfil.Direccion1, perfil.Telefono1);
        }
